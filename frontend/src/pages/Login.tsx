  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (axios.isAxiosError(err) && err.response?.data?.message) {
        ...
        setError('Invalid credentials or network failure. Please try again.');
      }
    } finally {
    ...
    <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden bg-slate-950">
      ...
      <div className="w-full max-w-md glass-card rounded-2xl p-8 shadow-2xl z-10">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-white tracking-tight">Welcome to VaultFlow</h1>
          <p className="text-sm text-slate-400 mt-1">Sign in to your secure cloud workspace</p>
        </div>
        ...
        <div className="mt-8 text-center text-sm text-slate-400">
          Don't have a VaultFlow account?{' '}
